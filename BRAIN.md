...
Tooling stance: pnpm workspace, light Turborepo, Matt Pocock tsconfig base plus stricter local flags, TS7/tsgo fast typecheck, Ultracite with oxlint/oxfmt, Lefthook pre-commit format + full lint + full typecheck.
