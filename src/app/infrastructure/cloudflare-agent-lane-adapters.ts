...
const plannerPromptFor = (input: {
  ...
  [
    ...
    'When a generated workflow renders a public report artifact, include outputTarget.primaryDocument with artifactPath, publishPath, mediaType, and title. For Dream HITL reports, use {"artifactPath":"dream/hitl-report.mdsvx","publishPath":"report.mdsvx","mediaType":"text/mdsvx","title":"<report title>"}.',
