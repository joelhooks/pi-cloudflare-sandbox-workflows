/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8cfc0f546e201234c0b572622195d04f)
// Runtime types generated with workerd@1.20260601.1 2026-06-08 nodejs_compat
interface __BaseEnv_Env {
	WORKFLOW_APP_D1: D1Database;
	WORKFLOW_TELEMETRY: AnalyticsEngineDataset;
	ARTIFACTS: Artifacts;
	...
	GITHUB_BRANCH_COMMIT_SECRET_REF: "secretref:github-branch-commit";
	GITHUB_DRY_RUN_SECRET_REF: "secretref:github-dry-run";
	GITHUB_PULL_REQUEST_SECRET_REF: "secretref:github-pr";
	GITHUB_USER_AGENT: "pi-cloudflare-sandbox-workflows/0.0.0";
	LINEAR_AUTHORIZATION_SCHEME: "api-key";
	LINEAR_COMMENT_SECRET_REF: "secretref:linear-api";
	LINEAR_DRY_RUN_SECRET_REF: "secretref:linear-dry-run";
	LINEAR_USER_AGENT: "pi-cloudflare-sandbox-workflows/0.0.0";
	...
	WORKFLOW_APP_TELEMETRY_DATASET: "pi_cloudflare_sandbox_workflows_telemetry";
	WORKFLOW_APP_TIMEOUT_MS: "600000";
	WZRRD_DRY_RUN_SECRET_REF: "secretref:wzrrd-dry-run";
	WZRRD_PUBLISH_SECRET_REF: "secretref:wzrrd-api";
	WZRRD_SITE_REF: "wzrrd:default";
	WZRRD_USER_AGENT: "pi-cloudflare-sandbox-workflows/0.0.0";
	DISCORD_BOT_TOKEN: string;
	GITHUB_TOKEN: string;
	LINEAR_API_TOKEN: string;
	MEMORY_RELAY_TOKEN: string;
	PI_AUTH_JSON_B64: string;
	WORKFLOW_APP_ADMIN_TOKEN: string;
	WORKFLOW_APP_MODEL: string;
	WORKFLOW_APP_RUNS_TOKEN: string;
	WZRRD_API_TOKEN: string;
	Sandbox: DurableObjectNamespace<import("./src/app/worker").Sandbox>;
	WORKFLOW_CAPSULE_SUPERVISOR: DurableObjectNamespace<import("./src/app/worker").CloudflareWorkflowCapsuleSupervisor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/app/worker");
		durableNamespaces: "Sandbox" | "CloudflareWorkflowCapsuleSupervisor";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_SECRET_REF" | "DISCORD_DRY_RUN_SECRET_REF" | "DISCORD_USER_AGENT" | "GITHUB_BRANCH_COMMIT_SECRET_REF" | "GITHUB_DRY_RUN_SECRET_REF" | "GITHUB_PULL_REQUEST_SECRET_REF" | "GITHUB_USER_AGENT" | "LINEAR_AUTHORIZATION_SCHEME" | "LINEAR_COMMENT_SECRET_REF" | "LINEAR_DRY_RUN_SECRET_REF" | "LINEAR_USER_AGENT" | "PI_AUTH_SECRET_REF" | "WORKFLOW_APP_ARTIFACTS_ACCOUNT_ID" | "WORKFLOW_APP_ARTIFACTS_NAMESPACE" | "WORKFLOW_APP_DISCORD_POLICY_ID" | "WORKFLOW_APP_MAX_ACTIVE_LANES" | "WORKFLOW_APP_REPO_PREFIX" | "WORKFLOW_APP_TELEMETRY_DATASET" | "WORKFLOW_APP_TIMEOUT_MS" | "WZRRD_DRY_RUN_SECRET_REF" | "WZRRD_PUBLISH_SECRET_REF" | "WZRRD_SITE_REF" | "WZRRD_USER_AGENT" | "DISCORD_BOT_TOKEN" | "GITHUB_TOKEN" | "LINEAR_API_TOKEN" | "MEMORY_RELAY_TOKEN" | "PI_AUTH_JSON_B64" | "WORKFLOW_APP_ADMIN_TOKEN" | "WORKFLOW_APP_MODEL" | "WORKFLOW_APP_RUNS_TOKEN" | "WZRRD_API_TOKEN">> {}
}
