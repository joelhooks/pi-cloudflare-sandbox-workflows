...
if (!env.CLOUDFLARE_API_TOKEN) {
  console.error(
    [
      ...
      "Set it directly, or set CLOUDFLARE_API_TOKEN_SECRET_NAME to a local secrets entry.",
      "Example: CLOUDFLARE_API_TOKEN=$(secrets lease <secret-name>) pnpm prototype:observability:deploy",
    ].join("\n")
  );
  process.exit(1);
}
