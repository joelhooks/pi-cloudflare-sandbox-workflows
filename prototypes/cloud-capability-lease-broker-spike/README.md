...
Cloudflare Worker/Durable Object
  ...
  -> queues execution
  -> starts Sandbox payload generator
...
Cloudflare Sandbox
  -> receives only an authenticated Cloudflare Artifacts remote
  -> writes run/payload.json + run/capability-request.json
  -> pushes payload commit to Artifacts
